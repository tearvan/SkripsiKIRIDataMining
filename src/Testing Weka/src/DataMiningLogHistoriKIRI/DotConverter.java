...
public class DotConverter 
{
    ...
    public static String convert(SDForConvertTree data, int deep, String nodeName)
    {
        String result = "";
        String [] temp;
        ...
        for(int i = 0; i < 2; i++)
        {
            ...
            {
                // menghasilkan node
                String [] temp2 = data.getData(1).split("   ");
                ...
                data.buangArrayPertama();
                result += DotConverter.convert(data, deep+1, nodeName2);
