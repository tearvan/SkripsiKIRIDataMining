...
\section{Graphviz}
Graphviz merupakan perangkat lunak \textsl{open source} untuk visualisasi grafik. Dengan menggunakan graphviz, visualisasi grafik dapat dibuat dengan menulis kode. Berikut contoh kode yang dapat dijadikan input untuk aplikasi graphviz:
...
Maka hasil yang diperoleh dari perangkat lunak graphviz adalah

\begin{figure}[H]
\includegraphics[scale=0.9]{Gambar/Graphviz.jpg}
\caption[Hasil output Graphviz]{Hasil output Graphvi} 
