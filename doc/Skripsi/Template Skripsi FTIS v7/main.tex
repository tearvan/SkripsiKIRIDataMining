...
\begin{thebibliography}{1}
	\bibitem{DM} Data Mining {\em Data Mining Concepts and Techniques} 2006 : Jiawei Han and Micheline Kamber
	\bibitem{WK} http://weka.sourceforge.net/doc.stable/
	\bibitem{GH} http://www.graphviz.org/
\end{thebibliography}
